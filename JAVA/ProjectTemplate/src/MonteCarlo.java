...
public final class MonteCarlo {
	...
	public static void main(String[] args) {
		...
		/*
		 * Generate 2D points and count how many fall in the area of the circle
		 * of radius 1 centered at (1.0,1.0)
		 */
		while (ptsInInterval < n) {
			/*
			 * Generate pseudo-random number in [0.0,2.0) interval twice as x y
			 * coordinates.
			 */
			...
			ptsInInterval++;
			/*
			 * Check if point is in circle interval and increment counter if it
			 * is
			 */
		...
		/*
		 * Estimate percentage of points generated in [0.0,2.0) square interval
		 * that fall in the circle subinterval
		 */
